              ...
              <table className="w-full text-left text-xs">
                <thead className="bg-slate-100/80 text-slate-700 font-bold uppercase text-[10px] tracking-wider border-b border-slate-200">
                  <tr>
                    ...
                    <th className="p-3.5">Distance from <a href="https://www.rmkec.ac.in/2023/" target="_blank" rel="noopener noreferrer" className="hover:underline text-slate-800" title="Visit R.M.K. Engineering College Official Website">R.M.K. Engineering College</a></th>
